...
const TransactionList = () => {
    ...
    const handleDeposit = async (e) => {
        ...
        // Format phone number (remove spaces, ensure it starts with 0)
        ...
        try {
            console.log('📤 Sending deposit request:', { amount, phoneNumber: formattedPhone });
            ...
            if (response.data && response.data.success) {
                ...
                if (response.data.data?.externalReference) {
                    ...
                    // Fallback: refresh transactions and balance
                    fetchTransactions();
                ...
                toast.error(response.data?.message || 'Deposit failed. Please try again.');
            }
        } catch (error) {
